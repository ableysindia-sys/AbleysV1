...
import com.ableys.app.ui.screens.grow.SkillMapRowCard
import com.ableys.app.ui.screens.grow.getSkillPillarMetadata
import com.ableys.app.ui.screens.move.MoveActivityCard
        ...
        composeTestRule.setContent {
            AbleysTheme {
                Column(
                    ...
                    com.ableys.app.ui.screens.move.MoveDailyStreakCounterWidget(
                        currentStreakDays = 12,
                        movementDays = com.ableys.app.data.ledger.StreakCalculator.recentDays(
                            com.ableys.app.data.ledger.ProgressEvent.localDayOf(System.currentTimeMillis()), 7
                        ),
